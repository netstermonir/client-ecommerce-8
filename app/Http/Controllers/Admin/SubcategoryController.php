...
class SubcategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view(
            "admin.category.subcategory.index",
    ...
    public function store(Request $request)
    {
        ...
        $notify = [
            "messege" => "SubCategory Create Sucessfull !",
            "alert-type" => "success",
        ];
        return redirect()
            ->back()
    ...
    public function edit($id)
    {
        ...
        $data = DB::table("subcategories")
            ...
            ->first();
        return view(
            "admin.category.subcategory.edit",
            compact("category", "data")
        );
    }
    ...
    public function update(Request $request)
    {
        ...
        DB::table("subcategories")
            ...
            ->update($data);
        $notify = [
            "messege" => "SubCategory Update Sucessfull !",
            "alert-type" => "success",
        ];
        return redirect()
            ->back()
    ...
    public function destroy($id)
    {
        DB::table("subcategories")
            ...
            ->delete();
        $notify = [
            "messege" => "SubCategory Delete Sucessfull !",
            "alert-type" => "success",
        ];
        return redirect()
            ->back()
